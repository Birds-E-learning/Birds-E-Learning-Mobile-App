...
import 'package:birds_learning_network/src/features/unregistered_user_flow/course/view/widgets/testimony_card.dart';
...
class UnregisteredCourseReviewWidget extends StatelessWidget with HomeWidgets, ContentWidget{
  const UnregisteredCourseReviewWidget({super.key, required this.courseId});
