...
import 'package:birds_learning_network/src/features/core/blog/view/screen/news_screen.dart';
...
class BlogNewsSection extends StatefulWidget {
  const BlogNewsSection({super.key});

  @override
  State<BlogNewsSection> createState() => _BlogNewsSectionState();
}

class _BlogNewsSectionState extends State<BlogNewsSection> {
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index){
                    return GestureDetector(
                      onTap: () =>
                          RoutingService.pushRouting(context, NewsScreen(category: news.newsCategories[index])),
                      child: NewsCategoryContainer(
